...
if __name__ == '__main__':
	...
	fig, ax = plt.subplots()
	ax.plot(range(0,144),bin_count_matrix[cell_row,cell_col,0,:])

	handles, labels = ax.get_legend_handles_labels()
	ax.legend(handles, labels)
	plt.xticks(np.arange(0, 144, step=2),('0h', '1h','2h','3h','4h','5h','6h','7h','8h','9h','10h','11h','12h','13h','14h','15h','16h','17h','18h','19h','20h','21h','22h','23h','24h'))
