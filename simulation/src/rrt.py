...
class RRT(object):
    ...
    def __init__(self, start, goal, obstacle_list, xlimits, ylimits,
                 expand_dis=10.0, path_resolution=2, goal_sample_rate=5, max_iter=500):
        """
        Setting Parameter
...
def startSearching(sx, sy, gx, gy, xmin, ymin, xmax, ymax, obstacleList):
...
if __name__ == '__main__':
    startSearching(0, 1, 15, 15, -1, 0, 16, 17, '')
